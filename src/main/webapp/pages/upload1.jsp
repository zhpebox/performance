...
<body>  
    ...
    <form name="userForm1" action="/GeneratorDataWeb/springMVC7/upload.do" enctype="multipart/form-data" method="post">  
        <div id="newUpload1">  
    ...
    <form name="userForm2" action="/GeneratorDataWeb/springMVC7/upload2.do" enctype="multipart/form-data" method="post"">  
<!--     <form name="userForm2" action="/GeneratorDataWeb/SpringMVC006/springUpload.do" enctype="multipart/form-data" method="post"">   -->
        <div id="newUpload2">  
            <input type="file" name="file">  
        </div>  
